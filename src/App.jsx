  ...
  return (
    <div className="App">
      ...
      <Carousel
        ...
        navButtonsProps={{ style: { backgroundColor: 'black', color: 'white' } }} // Adjust nav buttons style
      >
      ...
      <div style={{ display: 'flex', height: '100%' }}>
        {imagesToDisplay.map((image, index) => (
          <div key={index} style={{ flex: '1', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src={image} alt="Fashion" style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain' }} />
          </div>
        ))}
      </div>
    </Paper>
